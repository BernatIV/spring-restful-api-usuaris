...
/**
 * Heredem de BasicAuthenticationFilter perquè Spring ens posi aquesta classe a al seu lloc
 * dins de Filter Chain
 */
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    /**
     * Llegeix el token i utilitza Jwts per validar-lo.
     * Si va bé retornem UsernamePasswordAuthenticationToken.
     */
